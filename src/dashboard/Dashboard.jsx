...
// const Dashboard = () => {
//     const [chartType, setChartType] = useState('bar'); // State to store the selected chart type
//     const itemsState = useSelector(state => state.items);
//     const personsState = useSelector(state => state.persons);
//     const complainsState = useSelector(state => state.complain);
//     const authState = useSelector(state => state.user);
...
//     const createChartData = (dataByDate, label, backgroundColor) => {
//         const labels = Object.keys(dataByDate).sort();
//         const data = labels.map(date => dataByDate[date]);
...
//     const userChartData = createChartData(usersByDate, 'Users', 'rgb(59 130 246 / 1)');
//     const itemsChartData = createChartData(itemsByDate, 'Items', 'rgb(34 197 94 /1)');
//     const personsChartData = createChartData(personsByDate, 'Persons', '#E1752C');
//     const complainsChartData = createChartData(complainsByDate, 'Complains', 'rgb(238 17 17 / 1)');
...
//                 <h1 className="text-3xl font-semibold mb-5">Admin Dashboard</h1>
//                 <div className="mb-6">
//                     <label className="mr-3">Select Chart Type:</label>
...
//                     </div>
//                     <div className="bg-white dark:bg-dark p-5 rounded-md shadow-md h-full">
//                         {renderChart(itemsChartData)}
//                     </div>
//                     <div className="bg-white dark:bg-dark p-5 rounded-md shadow-md h-full">
//                         {renderChart(personsChartData)}
//                     </div>
//                     <div className="bg-white dark:bg-dark p-5 rounded-md shadow-md h-full">
//                         {renderChart(complainsChartData)}
//                     </div>
//                 </div>
//             </div>
//         </div>
